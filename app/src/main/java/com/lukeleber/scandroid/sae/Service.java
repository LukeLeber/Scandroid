...
public enum Service
{
    LIVE_DATASTREAM(1, "Live Datastream", "Retrieve information from the currently active data-stream"),
    FREEZE_FRAME_DATASTREAM(2, "Freeze-Frame Data", "Retrieve information from freeze-frame data (if present)"),
    ...
    TEST_RESULTS_NON_CAN(5, "Test Results (non-CAN)", "Retrieve test results for non-CAN protocols"),
    TEST_RESULTS_CAN_ONLY(6, "Test Results (CAN)", "Retrieve test results for CAN protocols"),
    RETRIEVE_PENDING_DTC(7, "Read Pending Codes", "Retrieve diagnostic trouble codes (DTCs) that were detected during " +
    ...
    RETRIEVE_PERMANENT_DTC(10, "Read Permanent Codes", "Retrieve permanent diagnostic trouble codes (DTCs)");
